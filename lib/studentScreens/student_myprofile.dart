...
class _StudentProfileState extends State<StudentProfile> {
  ...
  fileFromImageUrl() async {
    if (authController.myStudent.image == "" ||
        authController.myStudent.image == null) {
      return null;
    } else {
      final response =
          await http.get(Uri.parse(authController.myStudent.image!));
  ...
  void initState() {
    ...
    fileFromImageUrl();
    first_nameController.text = authController.myStudent.first_name ?? "";
    last_nameController.text = authController.myStudent.last_name ?? "";
    areaController.text = authController.myStudent.area ?? "-1";
    ageController.text = authController.myStudent.age ?? "";
    genderController.text = authController.myStudent.gender ?? "-1";
    levelController.text = authController.myStudent.level ?? "-1";
  }
                    ...
                    Align(
                      ...
                      child: InkWell(
                        ...
                        child: accountimage == null &&
                                (authController.myStudent.image == "" ||
                                    authController.myStudent.image == null)
                            ? Container(
                                width: 120,
                                height: 128,
